            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-8 col-sm-7 col-xs-7">
                    ...
                    <?php else: ?>
                        ...
                        ?>
                        <a href="<?php echo get_post_type_archive_link(get_post_type()); ?>" class="tagName fashion"><?php echo $name; ?></a>
                    <?php endif; ?>
                </div>
        ...
        <div class="contentArticle">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 articleRight">
                    ...
                    <?php endif; ?>
                    <?php if(get_field('author') || get_field('credits_by')): ?>
                    <div class="titleText">
                        <?php if(get_field('author')): ?>
                            <div><?php the_field('author'); ?></div>
                        <?php endif; ?>
                            <div><?php echo stripslashes(get_field('credits_by'));?></div>
