...
<?php wp_reset_query(); ?>
<?php if($count>= 13): ?>
    <?php if($thenatives['thenatives_event_ads_bottom']): ?>
        <div class="verticalSpacing-lg"></div>

        <section class="bgNeuw">
            <div class="imgBanner-small">
                <a href="<?php echo get_field('url',$thenatives['thenatives_event_ads_bottom']); ?>">
                    <img src="<?php echo get_field('image',$thenatives['thenatives_event_ads_bottom']); ?>">
                </a>
            </div>
        </section>
    <?php endif; ?>
