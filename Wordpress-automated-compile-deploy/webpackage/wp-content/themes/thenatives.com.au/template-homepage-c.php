<?php get_header('homepage-c'); ?>
    <section>
        <div class="bigPostChoose">
            <div class="container">
                <div class="row">
                    <?php if (get_field('banner_post')) {
                        $banner = the_repeater_field('banner_post')?>
                        <h1 class="titleBigPostChoose col-lg-12 col-md-12 col-sm-12 col-xs-12"><?php the_sub_field('title_banner_'); ?></h1>
                        <h2 class="timeBigPostChoose col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <span><?php the_sub_field('post_day_'); ?></span>
                        </h2>
                    <?php
                    }
                    ?>
